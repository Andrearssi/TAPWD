...
<body>
  <!-- Header -->
  <nav id="autohide" class="navbar navbar-dark navbar-expand-md fixed-top">
    <div class="container">
  ...
  <nav class="navbar sticky-top bg-light">
    <div class="container">
      <a class="navbar-brand">Gallery Candi</a>
  ...
  <?php
  $sql = "SELECT * FROM artikel ORDER BY id DESC LIMIT 3"; //mengurutkan berdasarkan yang terbaru dan limit 3 data dari tabel artikel
    ...
    <section class="photo-gallery py-4 py-xl-5">
      <div class="container-fluid p-0">
        <div class="row g-0 mb-2">
          <div class="col-xl-11 col-md-10 col-sm-9 text-center mx-auto">
            <h2><?= $r['title'] ?></h2>
        ...
        <div class="row g-0 row-cols-1 row-cols-md-2 row-cols-xl-3 photos mb-5" data-bss-baguettebox>
          ...
          $sql_image = "SELECT * FROM image INNER JOIN artikel 
                ...
                WHERE artikel.title = '$title'"; //select image 
